        ...
        if ($result) {
            ...
            while ($row = pg_fetch_assoc($result)) {
                echo "<tr>
                        ...
                        <td>" . $row['statut'] . "</td>
                        <td><button class='louer-button' onclick='louerConfirmation(" . $row['idmatos'] . ", \"" . $row['nommateriel'] . "\", " . $row['prixheure'] . ", ". $row['prixHeureSupp'] ." ," . $idClient . ")'>Louer</button></td>
                      </tr>";
            }
