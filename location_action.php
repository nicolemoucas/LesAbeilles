...
<body>
    ...
    <div class="container">
        ...
        if(isset($_GET['idMatos']) && isset($_GET['nomMatos']) && isset($_GET['prixHeure']) && isset($_GET['idClient']) && isset($_GET['choixPaiement']) && isset($_GET['timestampLocation']) && isset($_GET['dureeLocation'])) {
            ...
            $result = pg_query_params($connexion, 'CALL creer_location($1, $2, $3, $4, $5, $6, $7)', array($idMatos, $nomMatos, $prixHeure, $idClient, $choixPaiement, $timestampLocation, $dureeLocation));
